...
<table border='0' width='980' name='ctn' cellSpacing=0 cellPadding=0 >
	<tr><td ><?php include 'includesitq2vk/ctnheadersearch.php'; ?> </td></tr>
    <tr><td >
    ...
    <tr>
    	<td width='254'>
    	 ...
    	 <tr><td><?php $keyword=addslashes($_GET['keyword']);
              
    	include 'includesitq2vk/kqsearchctnhoten.php'; ?> </td></tr>
    	 </table>	
    	</td >
    	<td width='726' valign='top'><?php include 'nhansuctncontenthoten.php'; ?></td>
    	</tr>	
    </table>	
    	</td></tr>
