...
<HTML><HEAD><TITLE> - Cơ Khí Sữa Chữa- Quản lý đối tượng xã hội </TITLE>
...
<tr><td valign='top'>
   ...
   <tr><td>
    ...
    $nam=0;
    $nu=0;	 
    $mysqlnv=@mysql_query("select * from qlns_hosonhanvien where qlns_mact='16' and qlns_tinhtrangnv='1' order by qlns_hsnv");
