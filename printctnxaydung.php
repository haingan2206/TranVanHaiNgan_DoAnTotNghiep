...
<HTML><HEAD><TITLE> - Quản Lý Xây Dựng - Quản lý đối tượng xã hội </TITLE>
...
<tr><td valign='top'>
   ...
   <tr><td height='15'><div align='right'><a href='images/listexcel/danhsachnhanvienctnxaydung.xls'><img src='images/excel.png' border='0' width='32' height='32'><span class='danhsachnv'> Convert to excel <span></a></td></tr>			 
    <tr><td height='10'></td></tr>
   <tr><td>
    ...
    $nam=0;
    $nu=0;	 
    $mysqlnv=@mysql_query("select * from qlns_hosonhanvien where qlns_mact='18' and qlns_tinhtrangnv != 2 order by qlns_hsnv");
